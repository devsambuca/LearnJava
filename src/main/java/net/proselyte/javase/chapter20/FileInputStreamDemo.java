 ...
 * Требуется установка комплекта JDK, начиная с варсии 7
 */
public class FileInputStreamDemo {
    public static void main(String[] args) {
        ...
        try (FileInputStream f = new FileInputStream("/java/FileInputStreamDemo.java")) {


            System.out.println("Обшее количество доступныя байтов: " + (size = f.available()) );
            int n = size / 40;
            System.out.println("Первые " + n + " байтов, " + "прочитанных из файла по очереди методов read()");
